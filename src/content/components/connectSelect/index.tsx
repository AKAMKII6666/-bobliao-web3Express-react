        ...
        return (
            <>
                ...
                {(function () {
                    if (mode === EccShowMode.WINDOW) {
                        return (
                            <SmartLay title={'链接钱包'} ref={selectWindow}>
                                <div
                                    className="rrt_connectSelect_window"
                                    onClick={function () {
                                        selectWindow.current.hide(function () {});
                                    }}
                                >
                                    {(function () {
                                        if (walletData.currentAccount === '') {
                                            return (
                                                <>
                                                    <span onClick={connectLocalWallet}>
                                                        {' '}
                                                        {'鏈接本地錢包 / 瀏覽器插件'}{' '}
                                                    </span>
                                                    <label onClick={connectAsyncWallet}> {'WalletConnect'} </label>
                                                </>
                                            );
                                        } else {
                                            return (
